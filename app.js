...
const screens=[
 ...
 ()=>teach('02','1','LISTEN','Before joining, work out what people are talking about.',['<strong>Current topic:</strong> this handball game.','Sports, feet and playgrounds are related ideas, but they are not the topic Maya and Milo are talking about right now.'],'Stay with the topic people are discussing now.','',icons.listen,()=>go(13)),
